...
export class ApiCallService {
  ...
  uploadImageFromFile(file: File, weight, fat_percent, comment, type): Observable<any> {
    this.presentLoading();
  ...
  uploadImageFromBlob(blob: Blob, filename, weight, fat_percent, comment, type): Observable<any> {
    this.presentLoading();
    //should be always authenticated call
    const formData = new FormData();
    formData.append("action", "saveImage" );
